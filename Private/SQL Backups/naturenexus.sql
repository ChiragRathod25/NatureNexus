...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2024 at 02:11 PM
...
CREATE TABLE `payments` (
  ...
  `order_id` int(11) NOT NULL,
  `payment_method` enum('upi','credit_card','debit_card','netbanking') NOT NULL,
...
--
-- Table structure for table `user_mobiles`
--
...
--
-- Indexes for table `user_mobiles`
--
...
--
-- AUTO_INCREMENT for table `user_mobiles`
--
ALTER TABLE `user_mobiles`
...
--
ALTER TABLE `carts`
  ADD CONSTRAINT `carts_ibfk_1` FOREIGN KEY (`consumer_id`) REFERENCES `consumers` (`consumer_id`);
...
--
ALTER TABLE `farmers`
  ADD CONSTRAINT `farmers_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`);

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`consumer_id`) REFERENCES `consumers` (`consumer_id`);
...
ALTER TABLE `reviews`
  ...
  ADD CONSTRAINT `reviews_ibfk_2` FOREIGN KEY (`consumer_id`) REFERENCES `consumers` (`consumer_id`);
...
--
-- Constraints for table `user_mobiles`
--
ALTER TABLE `user_mobiles`
  ADD CONSTRAINT `user_mobiles_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`);
COMMIT;
